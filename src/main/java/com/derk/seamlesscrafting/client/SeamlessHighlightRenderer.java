...
public final class SeamlessHighlightRenderer {
    private static final int FULL_BRIGHT = 15728880;

    private SeamlessHighlightRenderer() {
    }

    public static void renderBox(MatrixStack matrices, VertexConsumer consumer, Vec3d camPos, Box box, float alpha) {
        int highlightColor = SeamlessCraftingConfig.getHighlightColor();
        int color = ColorHelper.getArgb(
                (int)(alpha * SeamlessCraftingConfig.getHighlightOpacity() * 255),
