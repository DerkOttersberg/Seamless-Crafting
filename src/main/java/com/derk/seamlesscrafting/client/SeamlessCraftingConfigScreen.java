...
import com.derk.seamlesscrafting.SeamlessCraftingConfig;
import com.derk.seamlesscrafting.SeamlessCraftingConfig.ConfigData;
import com.derk.seamlesscrafting.SeamlessCraftingConfig.LocateTrailParticle;
...
public class SeamlessCraftingConfigScreen extends Screen {
	...
	public SeamlessCraftingConfigScreen(Screen parent) {
		super(Text.of("Seamless Crafting Settings"));
		this.parent = parent;
	}

	@Override
	protected void init() {
		ConfigData config = SeamlessCraftingConfig.snapshot();
		...
		this.highlightColorPickerButton = this.addDrawableChild(ButtonWidget.builder(Text.of("Pick"), button -> this.client.setScreen(new SeamlessColorPickerScreen(this, this.derk$parseHexColor(this.highlightColorField.getText()), color -> this.highlightColorField.setText(String.format(Locale.ROOT, "#%06X", color)))))
	...
	private void derk$save() {
		try {
			ConfigData updated = SeamlessCraftingConfig.snapshot();
			...
			SeamlessCraftingConfig.update(updated);
